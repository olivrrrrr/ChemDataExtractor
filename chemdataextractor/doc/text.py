...
from ..parse.ratio import RatioParser
...
class Paragraph(Text):
    ...
    parsers = [CompoundParser(), ChemicalLabelParser(), NmrParser(), IrParser(), UvvisParser(), MpParser(), TgParser(), ContextParser(), RatioParser()]
